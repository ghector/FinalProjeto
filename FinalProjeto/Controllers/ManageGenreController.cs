...
namespace FinalProjeto.Controllers
{
    ...
    public class ManageGenreController : Controller
    {
        ...
        // GET: ManageGenre/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: ManageGenre/Create
